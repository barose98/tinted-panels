...
<xsl:variable name="amp" select="'$amp;'"/>
<xsl:variable name="lt" select="'$lt;'"/>
<xsl:variable name="gt" select="'$gt;'"/>
...
<xsl:variable name="RICONS" select="'/home/roseba/Projects/SOFT/BASH/Rokontroller/icons'"/>
<xsl:variable name="BASH" select="'SOFT/BASH'"/>
